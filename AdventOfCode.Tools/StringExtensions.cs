...
public static class StringExtensions
{
    ...
    public static IEnumerable<int> ExtractInts(this string text) => Regex.Matches(text, @"-?\d+").Select(m => int.Parse(m.Value));
    public static IEnumerable<int> ExtractPositiveInts(this string text) => Regex.Matches(text, @"\d+").Select(m => int.Parse(m.Value));
}
